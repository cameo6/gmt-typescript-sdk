...
export abstract class AbstractPage<Item> implements AsyncIterable<Item> {
  ...
  constructor(client: Gmt, response: Response, body: unknown, options: FinalRequestOptions) {
    this.#client = client;
...
export class PageNumber<Item> extends AbstractPage<Item> implements PageNumberResponse<Item> {
  ...
  constructor(client: Gmt, response: Response, body: PageNumberResponse<Item>, options: FinalRequestOptions) {
