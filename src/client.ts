...
import { AccountListCountriesParams, AccountListCountriesResponse, AccountListCountriesResponsesPageNumber, AccountListParams, AccountListResponse, AccountListResponsesPageNumber, AccountRetrieveResponse, Accounts } from './resources/accounts';
import { PurchasesByHash, PurchasesByHashRequestVerificationCodeParams, PurchasesByHashRequestVerificationCodeResponse, PurchasesByHashRetrieveResponse } from './resources/purchases-by-hash';
...
import { Profile, ProfileChangeLoginParams, ProfileChangeLoginResponse, ProfileChangePasswordParams, ProfileChangePasswordResponse, ProfileRetrieveResponse, ProfileUnbindTelegramResponse } from './resources/profile/profile';
import { PurchaseCreateParams, PurchaseCreateResponse, PurchaseListParams, PurchaseListResponse, PurchaseListResponsesPageNumber, PurchaseRefundResponse, PurchaseRequestVerificationCodeParams, PurchaseRequestVerificationCodeResponse, PurchaseRetrieveResponse, Purchases } from './resources/purchases/purchases';
import { Telegram, TelegramGetPremiumPriceParams, TelegramGetPremiumPriceResponse, TelegramGetStarsPriceParams, TelegramGetStarsPriceResponse } from './resources/telegram/telegram';
...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['GMT_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['GMT_LOG'] or 'warn' if it isn't set.
   */
...
export class Gmt {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Gmt.DEFAULT_TIMEOUT /* 1 minute */;
    this.logger = options.logger ?? console;
    const defaultLogLevel = 'warn';
    // Set default logLevel early so that we can log a warning in parseLogLevel.
    this.logLevel = defaultLogLevel;
    this.logLevel = parseLogLevel(options.logLevel, 'ClientOptions.logLevel', this) ?? parseLogLevel(readEnv('GMT_LOG'), 'process.env[\'GMT_LOG\']', this) ?? defaultLogLevel;
  ...
  static GmtError = Errors.GmtError;
...
export {
  type PageNumberParams as PageNumberParams,
  type PageNumberResponse as PageNumberResponse
};
