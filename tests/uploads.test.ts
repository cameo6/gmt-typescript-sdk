import fs from 'fs';
import type { ResponseLike } from 'gmt-typescript-sdk/internal/to-file';
import { toFile } from 'gmt-typescript-sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('gmt-typescript-sdk/core/uploads');
    await expect(
